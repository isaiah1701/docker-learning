...
This repository documents my hands-on learning journey with Docker through two containerized mini-projects. Each project demonstrates a different use case and core Docker concepts — from building images and composing services to networking and scaling.
...
### 1. `hello_flask/`
> A simple Flask + MySQL app that outputs a basic greeting and the connected MySQL version. It is pushed to an AWS Elastic Container Registry (ECR) to demonstrate image hosting and pulling.
...
### 2. `flask-challenge/`
> A multi-container Docker app using Flask, Redis, and NGINX. It counts how many times a user visits the page and demonstrates container communication, networking, load balancing, and scaling.
...
Feel free to fork this, open issues, or DM me if you're also learning Docker — happy to help or learn together.

---

## ©️ Author

Created by [isaiah1701](https://github.com/isaiah1701) – built to learn, shared to teach.
